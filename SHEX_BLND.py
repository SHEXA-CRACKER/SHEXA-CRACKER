...
TELEGRAM:CHANNEL//@SHEX_CRACKER-GRUPCHAT
...
TELEGRAM:CHANNEL//@SHEX_CRACKER_GRUPCHAT """
print " \x1b[1;93m{---------------------------------------SHEX_CRACKER\x1b[1;31m----------------------------------------}"
...
while (loop == 'true'):
    ...
    if (username == Username):
        ...
        print "Eeror"
        os.system('xdg-open https://wwwsnapchat.com/add/k4ro_2')
